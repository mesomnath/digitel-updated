...
<%
    ...
    try
    {
   	...
   	// Class.forName("oracle.jdbc.driver.OracleDriver");
   	 ...
   	 String query;
     query="SELECT email, tel_number from digitadmin where user_id='"+userid+"'";
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                    	    ...
                    	    <div class="form-group mt-2">
                              ...
                              <input type="text" class="form-control mt-0 disabled" disabled name="email" value="<%=rs.getString("email") %>" required>                            
                            </div>
                        
                            <div class="form-group mt-2">
                              <label class="mb-0"><b>Mobile Number</b></label>
                              <input type="text" class="form-control mt-0 disabled" disabled name="tel_number" value="<%=rs.getString("tel_number") %>" required>
